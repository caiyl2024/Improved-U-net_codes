...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.avg_pool = nn.AdaptiveAvgPool2d(4)#自适应平均池化，将输入转换为channel*1*1大小
    ...
    def forward(self, x):
        ...
        h=x.shape[2]/4
        w=x.shape[3]/4
        up=nn.UpsamplingNearest2d(scale_factor=(h,w))
        out=up(out)
        #print(out)
        #out =out.expand_as(out)
